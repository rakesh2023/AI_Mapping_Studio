...
function renderKPIs(stats, mappings){
  ...
  const cards = [
    ...
    {label:"Target Tables", value: stats.targetTables, icon:"bi-diagram-2", accent:"green", sub: tgtSub},
    {label:"Target Columns", value: stats.targetColumns, icon:"bi-list-columns-reverse", accent:"green", sub: tgtSub},
